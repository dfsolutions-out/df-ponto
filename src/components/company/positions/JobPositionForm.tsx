...
const initialState: JobPositionActionState = {
  success: false,
  message: null,
  fieldErrors: {},
};
...
type JobPositionFormProps = {
  action: (
    previousState: JobPositionActionState,
    formData: FormData,
    ...
    <form action={formAction} className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Descreva as principais responsabilidades ou características deste cargo."
